...
import 'package:untitled3/screens/login/forget_password.dart';
import 'package:untitled3/screens/sign/sign.dart';
  ...
  child: ElevatedButton(
    style: ElevatedButton.styleFrom(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10), // نفس تصميم Login
      ),
    ),
    onPressed: () {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const SignPage()), // صفحة Sign Up
      );
    },
    child: Text(
      "sign_up".tr(), // ترجمة النص
